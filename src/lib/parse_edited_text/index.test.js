...
may helpful and ask my follow up are now that you have a teamviewer drop seventy percent complex kind of gross margin on target what in the next few months still and then on how should we think about the impact of makes versus                utilization versus the cost synergies from here

~Speaker_121~

you yeah that's a good question I think the back it's a it's a you know he's seventy point five percent gross margins seventy plus percent gross margins over putting up right now our function of obviously were were pretty well utilized in our fabs given the current business conditions in addition the industrial market is really driving a lot of growth for us right now and that tends to drive pretty solid margins as well in addition we've moved pretty early this quarter to capture some cost synergies on the gross margin line and up that all this he helped as well I think as we look in the next year you know if business conditions remain in there if this if business conditions are led by the industrial market we do have more synergies on the comm on the gross margin line we should do better but again it's all can be very much specific to the environment

~Speaker_305~

next year even if consumer decline next year and that should be had from

~Speaker_121~

more well I mean I would say you know our margins across all of our business is rushing quite good so I don't expect that to be a big
...
question comes from Ross Seymore with Deutsche Bank
...
// var result = parseEditedText(exampleText);
